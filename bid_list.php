...
// 查询招标公告，只取招标公告类型，按创建时间倒序
$sql = "SELECT id,project_name,notice_type,bid_no,publish_time FROM bid_info WHERE notice_type='招标公告' ORDER BY create_at DESC";
